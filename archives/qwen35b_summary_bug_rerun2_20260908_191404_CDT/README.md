# qwen35b: rerun targets (summary_failure_accounting, summary_related_response, tb_erasure_possible, tb_unverifiable) archived on 2026-09-08 19:14:04 CDT
...
Selection: cohort_model_path=qwen35b, rerun_reason in [summary_failure_accounting, summary_related_response, tb_erasure_possible, tb_unverifiable].
...
- This archive (2026-09-08 19:14 CDT, main and ablation together; the same loop also produced the devstral24b and
  glm47flash archives):

  ```bash
  python3 $T/scripts/archive_rerun_targets.py --rerun-csv $T/rerun_list/rerun_runs.csv \
    --cohort-model-path qwen35b \
    --rerun-reason summary_failure_accounting summary_related_response tb_erasure_possible tb_unverifiable \
    --archive-name qwen35b_summary_bug_rerun2_20260908_191404_CDT --execute
  ```
...
- 577 runs across 16 cells; recorded rows 1148 -> 571.
...
- d05__b2k__ss	structured-summarize	run_1	4
- d05__b2k__ss	structured-summarize	run_2	6
- d05__b2k__ss	structured-summarize	run_3	2
- d05__b2k__ss-partial	structured-summarize-partial	run_2	1
- d05__b2k__su-full	summarization	run_1	9
- d05__b2k__su-full	summarization	run_2	8
- d05__b2k__su-full	summarization	run_3	11
- d05__b2k__su-partial	summarization-partial	run_1	13
- d05__b2k__su-partial	summarization-partial	run_2	11
- d05__b2k__su-partial	summarization-partial	run_3	13
- d05__b3k__ss	structured-summarize	run_1	8
- d05__b3k__ss	structured-summarize	run_2	15
- d05__b3k__ss	structured-summarize	run_3	16
- d05__b3k__ss-partial	structured-summarize-partial	run_1	1
- d05__b3k__su-full	summarization	run_1	35
- d05__b3k__su-full	summarization	run_2	34
- d05__b3k__su-full	summarization	run_3	29
- d05__b3k__su-partial	summarization-partial	run_1	27
- d05__b3k__su-partial	summarization-partial	run_2	28
- d05__b3k__su-partial	summarization-partial	run_3	24
- d05__b4k__ss	structured-summarize	run_1	2
- d05__b4k__ss	structured-summarize	run_2	5
- d05__b4k__ss	structured-summarize	run_3	8
- d05__b4k__ss-partial	structured-summarize-partial	run_1	1
- d05__b4k__su-full	summarization	run_1	12
- d05__b4k__su-full	summarization	run_2	12
- d05__b4k__su-full	summarization	run_3	11
- d05__b4k__su-partial	summarization-partial	run_1	11
- d05__b4k__su-partial	summarization-partial	run_2	10
- d05__b4k__su-partial	summarization-partial	run_3	9
- di__b3k__otrc-ss-partial	otrc-ss-partial	run_1	2
- di__b3k__otrc-ss-partial	otrc-ss-partial	run_2	2
- di__b3k__otrc-ss-partial	otrc-ss-partial	run_3	1
- di__b3k__otrc-su-partial	otrc-su-partial	run_1	31
- di__b3k__otrc-su-partial	otrc-su-partial	run_2	30
- di__b3k__otrc-su-partial	otrc-su-partial	run_3	32
- di__b3k__trc-ss	trc-ss	run_1	4
- di__b3k__trc-ss	trc-ss	run_2	4
- di__b3k__trc-ss	trc-ss	run_3	6
- di__b3k__trc-su	trc-su	run_1	29
- di__b3k__trc-su	trc-su	run_2	32
- di__b3k__trc-su	trc-su	run_3	28
...
Verification: 571 + 577 = 1148; per-cell key sets preserved;
all 1154 destinations exist and sources are gone.
