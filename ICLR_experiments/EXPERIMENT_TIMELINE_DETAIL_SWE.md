...
This follows the structure of [EXPERIMENT_TIMELINE_DETAIL.md on akiho-expansion-terminalbench-0829](https://github.com/ritulS/agentCtx/blob/41cd02e78d9d186a2f2c6a804b8ff18de6d03a32/ICLR_experiments/EXPERIMENT_TIMELINE_DETAIL.md). The remote branch tip was verified as `41cd02e78d9d186a2f2c6a804b8ff18de6d03a32` during compilation. SWE evidence below comes from this local workspace, not the Terminal-Bench host.
...
| GLM adopted launcher grid | 10,000 / 13,000 / 15,000 | [Launcher defaults](../scripts/run_agent_models_expansion.sh) and [experiment plan](../ICLR_experiments/FOLLOWUP_EXPERIMENTS.md); log explicitly records `budget=13000` for `bP`. A separate timestamped budget-approval event was not identified. |
