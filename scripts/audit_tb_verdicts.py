...
Rows written before ``scripts/bench_adapters/tb_verdict.py`` recorded
...
Read-only by default:
    ...
    python3 scripts/audit_tb_verdicts.py
    python3 scripts/audit_tb_verdicts.py --source-root ICLR_results/terminalbench2
    python3 scripts/audit_tb_verdicts.py --write            # backs up, then rewrites
"""
...
from bench_adapters.tb_verdict import VERDICT_FIELDS, trial_verdict  # noqa: E402
...
# but left to scripts/replay_reverify_tb.py (plan/recover/apply), which keeps
