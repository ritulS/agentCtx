...
# summarizer ablation (scripts/expansions/run_qwen_swe_summarizer_ablation.sh).
# Until 2026-09-21 this file was scripts/start_vllm_qwen35.sh; the Terminal-Bench
# launcher of the same name is now scripts/serving/start_vllm_qwen35_prefix_cache_ablation.sh.
...
# the same GPUs for a summarizer server (scripts/serving/start_vllm_summarizer.sh,
