...
#
# Usage:
#   bash scripts/calibration/run_budget_calibration_tb2.sh qwen [tasks-file]
#   bash scripts/calibration/run_budget_calibration_tb2.sh devstral
#   bash scripts/calibration/run_budget_calibration_tb2.sh glm
#   bash scripts/calibration/run_budget_calibration_tb2.sh all  # sequential
#
# Prerequisites:
