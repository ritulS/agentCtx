...
#   Agent      : Qwen3.5-35B-A3B  (scripts/serving/start_vllm_qwen35_swe_summarizer_ablation.sh,                :8000, GPUs 0-3 @0.70)
#   Summarizer : Qwen3.5-9B       (scripts/serving/start_vllm_summarizer.sh qwen35-9b, :8001, GPUs 0-3 @0.15)
...
#
# Usage: nohup bash scripts/expansions/run_qwen_swe_summarizer_ablation.sh > logs/followup_sb_qwen_sumabl_qwen9b.nohup.log 2>&1 &
...
#     ICLR_MODEL=qwen35b-sum-qwen35-9b-smoke bash scripts/expansions/run_qwen_swe_summarizer_ablation.sh
