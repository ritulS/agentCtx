#!/usr/bin/env bash
# Run the SWE-Bench prefix-caching ablation (scripts/expansions/run_qwen_swe_prefix_cache_ablation.sh)
# with Slack start/completion/failure notices, like run_agent_models_expansion_notified.sh.
#
# Prerequisites:
#   export SLACK_WEBHOOK_URL='https://hooks.slack.com/services/...'
#   bash scripts/serving/start_vllm_qwen35_prefix_cache.sh     # Qwen3.5-35B-A3B, prefix caching ON
#
# Usage:
#   nohup bash scripts/expansions/run_qwen_swe_prefix_cache_ablation_notified.sh \
