...
#                server: bash scripts/serving/start_vllm_qwen35_prefix_cache.sh
...
# Results go to ICLR_experiments/swebench/prefix_cache_ablation/qwen35b-prefixcache/<cell>.
...
#
# Usage: nohup bash scripts/expansions/run_qwen_swe_prefix_cache_ablation.sh > logs/followup_sb_qwen_prefixcache.nohup.log 2>&1 &
...
#     bash scripts/expansions/run_qwen_swe_prefix_cache_ablation.sh > logs/followup_sb_qwen_prefixcache.nohup.log 2>&1 &
...
#     ICLR_MODEL=qwen35b-prefixcache-smoke bash scripts/expansions/run_qwen_swe_prefix_cache_ablation.sh
...
ICLR_SECTION="prefix_cache_ablation"                # ICLR_experiments/swebench/prefix_cache_ablation/
...
if [[ " $server_cmdline " != *" --enable-prefix-caching "* || " $server_cmdline " == *" --no-enable-prefix-caching "* ]]; then
    ...
    echo "Restart it with: bash scripts/serving/start_vllm_qwen35_prefix_cache.sh" >&2
    exit 1
fi
