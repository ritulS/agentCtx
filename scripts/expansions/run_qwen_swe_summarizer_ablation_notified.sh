#!/usr/bin/env bash
# Run the SWE-Bench summarizer ablation (scripts/expansions/run_qwen_swe_summarizer_ablation.sh)
...
#   nohup bash scripts/expansions/run_qwen_swe_summarizer_ablation_notified.sh \
...
#     bash scripts/expansions/run_qwen_swe_summarizer_ablation_notified.sh \
