...
# Wraps scripts/expansions/run_qwen_tb_summarizer_ablation.sh; start vLLM (agent :8000,
# summarizer :8001) and the Podman socket separately.
#
# Usage:
#   export SLACK_WEBHOOK_URL='https://hooks.slack.com/services/...'
#   nohup bash scripts/expansions/run_qwen_tb_summarizer_ablation_with_slack.sh \
...
export ICLR_MODEL
bash scripts/expansions/run_qwen_tb_summarizer_ablation.sh
