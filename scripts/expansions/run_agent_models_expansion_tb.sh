...
#   Example (GLM):
#     ABLATION_PARTS="d03 d07" TB_LOG_SUFFIX=gpu0-3 bash scripts/expansions/run_agent_models_expansion_tb.sh glm ablation
#     ABLATION_PARTS="di d05"  TB_LOG_SUFFIX=gpu4-7 GLM_AGENT_CONFIG=configs/config-glm47flash-vllm-8004.yaml \
#         GLM_HEALTH_URL=http://localhost:8004/v1/models bash scripts/expansions/run_agent_models_expansion_tb.sh glm ablation
set -euo pipefail
