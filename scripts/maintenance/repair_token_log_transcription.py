...
`agentctx.benchmarks.swe_bench.SweBench._run_agent` copies the per-run token log into the result row at
...
Usage:
    python scripts/maintenance/repair_token_log_transcription.py                 # dry run
    python scripts/maintenance/repair_token_log_transcription.py --apply
    python scripts/maintenance/repair_token_log_transcription.py --root data/swebench --apply
    python scripts/maintenance/repair_token_log_transcription.py --report-csv /tmp/stale.csv
"""
